...
const ejs = require("ejs"); // Templating engine for rendering HTML views
...
app.set("view engine", "ejs");app.get('/flash', (req, res) => {
...
app.get("/wifiConnection", (req, res) => {
  res.render("wifiConnection", { title: "KstuWifiChatBox" }); // Render the about page
});

app.get("/portalConnection", (req, res) => {
  res.render("portalConnection", { title: "KstuPortalChatBox" }); // Render the about page
});

app.get("/test", (req, res) => {
  res.render("test", { title: "test" }); // Render the about page
});
